...
export function syncSongMarketingKitFromPack(songId, options = {}) {
  ...
  const assets = {
    ...
    square_post_url: byFormat('instagram-square-1080x1080.png')?.publicUrl || byFormat('ig-square-post-1080x1080.png')?.publicUrl || kit.marketing_assets.square_post_url || null,
    vertical_post_url: byFormat('instagram-vertical-1080x1920.png')?.publicUrl || byFormat('tiktok-cover.jpg')?.publicUrl || byFormat('ig-reel-cover.jpg')?.publicUrl || kit.marketing_assets.vertical_post_url || null,
    portrait_post_url: byFormat('facebook-post-1200x630.png')?.publicUrl || byFormat('ig-feed-announcement-1080x1350.png')?.publicUrl || kit.marketing_assets.portrait_post_url || null,
    outreach_banner_url: byFormat('facebook-post-1200x630.png')?.publicUrl || byFormat('outreach-hero-1600x900.png')?.publicUrl || kit.marketing_assets.outreach_banner_url || null,
    cover_safe_promo_url: byFormat('spotify-cover-3000x3000.png')?.publicUrl || byFormat('ig-reel-cover.jpg')?.publicUrl || kit.marketing_assets.cover_safe_promo_url || null,
    no_text_variation_url: byFormat('youtube-thumbnail-1280x720.png')?.publicUrl || byFormat('no-text-variation.png')?.publicUrl || kit.marketing_assets.no_text_variation_url || null,
...
function deriveAssetsFromSong(song, marketingPack, baseImage, links, defaults) {
  ...
  return {
    ...
    square_post_url: find('instagram-square-1080x1080.png')?.publicUrl || find('ig-square-post-1080x1080.png')?.publicUrl || null,
    vertical_post_url: find('instagram-vertical-1080x1920.png')?.publicUrl || find('tiktok-cover.jpg')?.publicUrl || find('ig-reel-cover.jpg')?.publicUrl || null,
    portrait_post_url: find('facebook-post-1200x630.png')?.publicUrl || find('ig-feed-announcement-1080x1350.png')?.publicUrl || null,
    outreach_banner_url: find('facebook-post-1200x630.png')?.publicUrl || find('outreach-hero-1600x900.png')?.publicUrl || null,
    cover_safe_promo_url: find('spotify-cover-3000x3000.png')?.publicUrl || find('ig-reel-cover.jpg')?.publicUrl || null,
    no_text_variation_url: find('youtube-thumbnail-1280x720.png')?.publicUrl || find('no-text-variation.png')?.publicUrl || null,
